            ...
            <div>
                ...
                <div className="row">
                    <div onClick={() => {this.onSubmit('/add')}} class="col-4">
                            ...
                            <div class="row"><div className="centerly"><span class="my-auto">Armário</span></div></div>
                    </div>
                    <div onClick={() => {this.onSubmit('/search')}} class="col-4">
                            ...
                            <div class="row"><div className="centerly"><span class="my-auto">Fornecedor</span></div></div>
                    </div>
                    <div onClick={() => {this.onSubmit('/devolute')}} class="col-4">
                            ...
                            <div class="row"><div className="centerly"><span class="my-auto">Modelo</span></div></div>
                    </div>
                </div>
            </div>
        )
